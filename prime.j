...
defun main
1 prime set_arg1 print_int endl  ; print the 1st prime on the ASCII display
2 prime set_arg1 print_int endl  ; print the 2nd prime on the ASCII display
3 prime set_arg1 print_int endl  ; print the 3th prime on the ASCII display
4 prime set_arg1 print_int endl  ; print the 4th prime on the ASCII display
5 prime set_arg1 print_int endl  ; print the 5th prime on the ASCII display
6 prime set_arg1 print_int endl  ; print the 6th prime on the ASCII display
7 prime set_arg1 print_int endl  ; print the 7th prime on the ASCII display
return 