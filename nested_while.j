...
1                 ; res=1
get_arg1       	  ; res=N?/n? n // inv:res==N?/n? where f(x)=x?=1*(product of all odd numbers y where 1<=y<=x), and N is original arg
...
defun main 
4 set_arg1 testWhile set_arg1 print_int endl
7 set_arg1 testWhile set_arg1 print_int endl
5 set_arg1 testWhile set_arg1 print_int endl
6 set_arg1 testWhile set_arg1 print_int endl
return
